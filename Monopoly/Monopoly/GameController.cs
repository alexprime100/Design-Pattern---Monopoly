...
namespace Monopoly
{
    class GameController
    {
        ...
        public void Start()
        {
            ...
            while (!this.model.End)  //while the party continues
            {
        ...
        public void PlayATurn(Dice d1, Dice d2)
        {
            ...
            else
            {
                ...
                {
                    this.model.Players[index].Balance -= this.model.Players[index].Position.Rent;
                    if (this.model.Players[index].Position.Rent > 0)
                    {
        ...
        public void BuyAPlace()
        {
            ...
            if (answer == "1")
            {
                this.model.Players[index].Balance -= this.model.Players[index].Position.Price;
                this.model.Players[index].Position.Owner = this.model.Players[index];
                this.model.Players[index].Properties.Add(this.model.Players[index].Position);
                this.model.Players[index].Properties.Sort();
                if (this.model.Players[index].Position.Index%10 + 5 == 0)
                {
                    UpdateStationRent();
                }
        ...
        public void PayRent()
        {
            ...
            this.model.Players[index].Balance -= this.model.Players[index].Position.Rent;
            int idPlayer = SearchPlayerID(this.model.Players[index].Position.Owner.Name);
            this.model.Players[idPlayer].Balance += this.model.Players[index].Position.Rent;
        }
        ...
        public void UpdateStationRent()
        {
            ...
            {
                this.model.Board[listStations[i]].Rent *= Convert.ToInt32(Math.Pow(2, listStations.Count - 1));
            }
        }
